...
st.set_page_config(
    layout="wide",
    page_icon= "shield",
    page_title= "AI InfuGenX-GPT_Shield"
)

st.title("GPT Shield: AI Plagiarism Detector")
with st.expander("See explanation"):
    st.write("A GPT Shield gives you the perplexity and burstiness scores for LLM generated responses. It helps you detect some sort of plagiarism in the generated responses.")
